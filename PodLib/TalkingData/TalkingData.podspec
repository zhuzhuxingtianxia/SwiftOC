#
#  Be sure to run `pod spec lint TalkingData.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TalkingData"
  spec.version      = "4.0.34"
  spec.summary      = "TalkingData应用统计分析工具"
  ...
  spec.description  = <<-DESC
                      TalkingData提供综合数据解决方案，帮助用户快速整合数据，并解决商圈经营，精准营销等场景问题。
                      DESC

  spec.homepage     = "http://doc.talkingdata.com/posts/20"
  ...
  spec.source       = { :git => "https://github.com/TalkingData.git", :tag => "#{spec.version}" }
  ...
  # 使用了第三方静态库
  # spec.ios.vendored_library = 'TalkingData/libTalkingData.a'
   spec.vendored_libraries = 'TalkingData/libTalkingData.a'
  # spec.vendored_frameworks = 'TalkingData/libTalkingData.a'
