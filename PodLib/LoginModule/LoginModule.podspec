...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "LoginModule登陆管理模块."
  ...
  TODO:LoginModule登陆管理模块,可定义手机号、密码、三方登陆操作等，保存数据供其他模块使用。
                   DESC
  ...
  spec.source       = { :git => "https://github.com/LoginModule.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "LoginModule", "LoginModule/**/*.{h,m,swift}"
  # spec.exclude_files = "LoginModule/Exclude"
